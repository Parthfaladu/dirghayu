...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $role = Role::create(['name' => 'manager','guard_name' => 'web'])->givePermissionTo(['add__package','update__package','view__package','delete__package','add__product','update__product','view__product', 'delete__product', 'add__product_sell', 'update__product_sell', 'view__product_sell', 'add__staff_member', 'view__staff_member', 'add__payment', 'update__payment', 'view__payment', 'add__enquiry', 'update__enquiry', 'view__enquiry', 'delete__enquiry', 'add__customer', 'update__customer', 'view__customer', 'add__subscription', 'view__subscription', 'add__notice', 'view__notice', 'add__expense', 'update__expense', 'view__expense', 'add__invoice', 'update__invoice', 'view__invoice', 'view__attendance', 'add__attendance', 'update__attendance','delete__attendance']);
        $role = Role::create(['name' => 'staff','guard_name' => 'web'])->givePermissionTo(['view__package', 'add__product', 'view__product', 'add__product_sell', 'update__product_sell', 'view__product_sell', 'add__payment', 'view__payment', 'add__enquiry', 'update__enquiry', 'view__enquiry', 'delete__enquiry', 'add__customer', 'update__customer', 'view__customer', 'add__subscription', 'view__subscription', 'view__notice', 'add__invoice', 'update__invoice', 'view__invoice', 'view__attendance', 'add__attendance', 'view__staff_member']);
        $role = Role::create(['name' => 'customer','guard_name' => 'web'])->givePermissionTo(['view__product', 'view__product_sell', 'view__payment', 'view__subscription', 'view__notice', 'view__invoice', 'view__attendance', 'view__package']);
    }
}  