	        ...
	        <div class="card-body col-sm-12">
	            ...
	            <form  @submit.prevent="submitForm()">
                    ...
                    <table align="center" width="100%" class="table">
						...
						<tbody>
							<tr v-for="(invoiceItem, index) in invoice.invoiceitems" :key="index" class="td-padding-left">
								<td>
									<input id="name" v-model="invoiceItem.name" type="text" class="form-control" name="name" readonly placeholder="Item Name" required>
								</td>
								<td>
									<input id="quantity" v-model="invoiceItem.quantity" type="number" class="form-control" name="quantity" placeholder="Item Quantity" required>
								</td>
								<td>
									<input id="rate" v-model="invoiceItem.rate" type="number" class="form-control" name="rate" placeholder="Item Rate" required>
								</td>
								<td>
									<input id="amount" type="number" class="form-control" name="amount" :value="invoiceItem.quantity*invoiceItem.rate" placeholder="Item Amount" style="border:none;" readonly required>
								</td>
								<td>
