                    ...
                    <table align="center" width="100%" class="table">
						...
						<tbody>
							<tr v-for="(invoiceItem, index) in invoice.invoiceitems" :key="index">
								<td><input type="text" class="form-control" name="name" v-model="invoiceItem.name" id="name" placeholder="Item Name" required></td>
	...
	async mounted() {
		try {
			if(this.$route.params.id != null)
			{
				...
				let res      = await axios.get('/api/v1/invoice/list/'+id , { headers: {"Authorization" : this.$store.getters['auth/authHeaders'].Authorization} })
