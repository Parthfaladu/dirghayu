                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="position-relative form-group">
                                ...
                                <select id="bill_to" v-model="invoice.bill_to" class="form-control" name="bill_to" required>
                    ...
                    <table align="center" width="100%" class="table">
						...
						<tbody>
							<tr v-for="(invoiceItem, index) in invoice.invoiceitems" :key="index">
								<td><input id="name" v-model="invoiceItem.name" type="text" class="form-control" name="name" placeholder="Item Name" required></td>
