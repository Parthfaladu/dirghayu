						...
						<div class="card mb-3 widget-content card-staff-member" >
							<div class="widget-content-outer">
								<div class="widget-content-wrapper">
									...
									<div class="widget-content-right">
										<div class="widget-numbers">{{ totalStaffmember }}</div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card mb-3 widget-content card-product-sold-color">
							<div class="widget-content-outer">
								<div class="widget-content-wrapper">
									...
									<div class="widget-content-right">
										<div class="widget-numbers">{{ $store.getters['init/currency'] }} {{ totalProductSell }}</div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card mb-3 widget-content card-enquiry-color" >
							<div class="widget-content-outer">
								<div class="widget-content-wrapper">
									...
									<div class="widget-content-right">
										<div class="widget-numbers">{{ totalEnquiry }}</div>
									</div>
								</div>
							</div>
						</div>
