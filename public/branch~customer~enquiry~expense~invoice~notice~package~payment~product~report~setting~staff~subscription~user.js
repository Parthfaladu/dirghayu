(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["branch~customer~enquiry~expense~invoice~notice~package~payment~product~report~setting~staff~subscription~user"],{
      ...
      _c("div", { staticClass: "app-sidebar__inner" }, [
        _c("ul", { staticClass: "vertical-nav-menu mt-4" }, [
          ...
          _c(
            "li",
            [
              _c("router-link", { attrs: { to: "/product-sell-report" } }, [
                _c("i", { staticClass: "metismenu-icon pe-7s-news-paper" }),
                _vm._v(
                  "\n                            Product Sell Report\n                        "
                )
