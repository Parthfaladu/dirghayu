        ...
        _vm.notice && _vm.userRoleList
          ? _c("div", { staticClass: "main-card mb-3 card" }, [
              _c("div", { staticClass: "card-body" }, [
                _c("h5", { staticClass: "card-title" }),
                _vm._v(" "),
                _c("div", { staticClass: "position-relative form-group row" }, [
                  _c(
                    "label",
                    { staticClass: "title-data h5", attrs: { for: "to_id" } },
                    [_vm._v("From")]
                  ),
                  _vm._v(" "),
                ...
                _c("div", { staticClass: "position-relative form-group row" }, [
                  _c(
                    "label",
                    { staticClass: "title-data h5", attrs: { for: "title" } },
                    [_vm._v("Title")]
                  ),
                  _vm._v(" "),
                  _c("div", { staticClass: "col-9" }, [
                ...
                _c("div", { staticClass: "position-relative form-group row" }, [
                  _c(
                    "label",
                    { staticClass: "title-data h5", attrs: { for: "detail" } },
                    [_vm._v("Detail")]
                  ),
                  _vm._v(" "),
                  _c("div", { staticClass: "col-9" }, [
                    _vm._v(" : " + _vm._s(_vm.notice.detail))
                  ])
                ])
              ])
            ])
